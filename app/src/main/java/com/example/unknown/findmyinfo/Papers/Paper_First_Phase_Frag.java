...
public class Paper_First_Phase_Frag extends Fragment {

    TextView tv_paper_phase_one;

    public Paper_First_Phase_Frag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_paper__first__phase_, container, false);

        tv_paper_phase_one = (TextView) view.findViewById(R.id.tv_paper_phase_one);
        return view;
    }
    ...
    public void getYear(String selected_year, String sub_name, final Context context){
        ...
        if(selected_year != null) {
            ...
            DatabaseReference child = reference.child(selected_sem).child(selected_field).child(sub_name).child(selected_year).child("phase_1");
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                                ...
                                if(snapshot.getKey().contains("link")){
                                    ...
                                    tv_paper_phase_one.setText(snapshot.getValue().toString());
                                }
                            }
