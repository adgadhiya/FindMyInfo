 ...
 */
public class Paper_Final_Frag extends Fragment {

    TextView tv_paper_final;

    public Paper_Final_Frag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_paper__final_, container, false);

        tv_paper_final = (TextView) view.findViewById(R.id.tv_paper_final);
    ...
    public void getYear(String selected_year, String sub_name,final Context context){
        ...
        if(selected_year != null) {
            ...
            DatabaseReference child = reference.child(selected_sem).child(selected_field).child(sub_name).child(selected_year).child("external");
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                                ...
                                if(snapshot.getKey().contains("link")){
                                    ...
                                    tv_paper_final.setText(snapshot.getValue().toString());
                                }
                            }
